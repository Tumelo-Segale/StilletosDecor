   ...
   window.STILLETOS_ADULT = (function () {
    ...
    function renderServices() {
      const cards = DATA.ADULT_SERVICES.map(
        (svc) =>
          ...
          '" alt="' +
          svc.title +
          '" loading="eager" decoding="async" referrerpolicy="no-referrer"></div>' +
    ...
    function renderRentals() {
      const cards = DATA.ADULT_RENTALS.map(
        (item) =>
          ...
          '" alt="' +
          item.name +
          '" loading="eager" fetchpriority="low" decoding="async" referrerpolicy="no-referrer"></div>' +
    ...
    function mediaTag(src, i) {
      ...
      return (
        ...
        '" alt="' +
        label +
        '" loading="eager" fetchpriority="low" decoding="async" referrerpolicy="no-referrer">'
      );
    }
